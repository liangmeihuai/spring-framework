...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	 ...
	 *
	 * * ���ݸ�����Դ������һ��XmlBeanFactory
	 * @param resource  Spring�ж����ⲿ��Դ�ĳ���������Ƕ��ļ��ĳ����ر���XML�ļ�������Resource����ͨ��
	 * �Ǳ�����Springʹ���ߵ�Bean���壬����applicationContext.xml�ڱ�����ʱ���ͻᱻ����ΪResource������
	 * @throws BeansException ������߽����з�������
	 */
